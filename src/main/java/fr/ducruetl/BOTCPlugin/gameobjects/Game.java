...
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Chef;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Empath;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.FortuneTeller;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Investigator;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Librarian;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Mayor;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Monk;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Ravenkeeper;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Slayer;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Soldier;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Undertaker;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Virgin;
import fr.ducruetl.BOTCPlugin.gameobjects.roles.townsfolks.Washerwoman;
